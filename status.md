...
- **Date**: 2026-09-25
- **Current State**: Installer version 0.3.0 released (`scripts/fabric-installer-v0.3.0.sh` and root `install.sh`). All changes committed to branch `main`. Development paused per user request.
...
- [x] Created `docs/hardware_specs.md` specifying Debian 13 as primary target across 4 sizing tiers (including lightweight client VM for LAN Ollama).
